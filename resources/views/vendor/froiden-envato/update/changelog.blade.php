<div class="row">
    ...
    <p>
        ...
        │       └── Package Offline payments
        │       └── Manage Contracts
        │       └── Client can purchase products
        │       └── Added Razorpay payment gateway
        │       └── Added Project burndown chart
        │       └── GDPR
        │       └── Now create invoices without project
        │       └── Added task dependency
        │       └── Assign agents to leads
        │       └── Send notices to client
        │       └── Added Gantt chart per project
        │       └── Upload images with task/project
        │       └── Bug fixes
        │
        │
        │   └── <strong>Version 3.1.1</strong>
        │       └── Rounded theme
        │       └── <a href="{{ route('super-admin.front-settings.index') }}"><u>Social media links settings for front end theme</u></a>
        │       └── <a href="{{ route('super-admin.footer-settings.index') }}"><u>Front end footer menu settings</u></a>
        │       └── New pending leaves page in admin panel
        │       └── Bug fixes
        │
        ...
        │       └── Generate credit notes form invoices
        │       └── Bug fixes
        │
