            ...
            <div class="row ">
                <div class="col-xs-12 m-b-10">
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="text" name="start_date_1" id="start_date_1" class="form-control" value="{{ $contract->start_date->format('m/d/Y') }}">
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 m-b-10">
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="text" name="end_date_1" id="end_date_1" class="form-control" value="{{ $contract->end_date->format('m/d/Y') }}">
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 m-b-10">
