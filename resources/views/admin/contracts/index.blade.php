...
//                                    swal("Deleted!", response.message, "success");
    ...
    function loadTable (){
        ...
        table = $('#invoice-table').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('admin.contracts.data') !!}?startDate=' + startDate + '&endDate=' + endDate + '&contractType=' + contractType + '&clientID=' + clientID,
            "order": [[ 0, "desc" ]],
            language: {
            ...
            columns: [
                ...
                { data: 'client.name', name: 'client.name', width: '10%' },
                { data: 'contract_type.name', name: 'contract_type.name', width: '13%' },
