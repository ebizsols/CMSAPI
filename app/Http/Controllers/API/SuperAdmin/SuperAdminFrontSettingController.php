...
use App\Http\Requests\API\SuperAdmin\FrontSetting\FrontSettingRequest;
use App\Http\Requests\API\SuperAdmin\FrontSetting\FrontSettingUpdateRequest;
...
class SuperAdminFrontSettingController extends SuperAdminBaseController
{
     ...
     */
    public function index(FrontSettingRequest $request)
    {
        $data=array();
        $data['global'] = GlobalSetting::first();

        $data['frontDetail'] = FrontDetail::first();
     ...
     * @return array
     */
    public function update(FrontSettingUpdateRequest $request)
    {
        ...
        return $request->successResponse($setting,__('messages.uploadSuccess'));
