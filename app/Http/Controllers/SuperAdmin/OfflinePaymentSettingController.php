...
//        }
    ...
    public function index()
    {
        ...
        return view('super-admin.stripe-settings.offline-method.index', $this->data);
    }
    ...
    {
        return view('super-admin.stripe-settings.offline-method.create-modal', $this->data);
    }
    ...
    public function store(SuperAdminStoreRequest $request)
    {
        ...
        return Reply::redirect(route('super-admin.offline-payment-setting.index'), __('messages.methodsAdded'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('super-admin.stripe-settings.offline-method.edit', $this->data);
    }
    ...
    public function destroy($id)
    {
        ...
        return Reply::redirect(route('super-admin.offline-payment-setting.index'), __('messages.methodsDeleted'));

    }

    public function createModal(){
        return view('super-admin.stripe-settings.offline-method.create-modal');
    }
}
