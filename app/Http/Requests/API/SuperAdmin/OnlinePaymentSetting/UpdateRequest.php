...
class UpdateRequest extends SuperAdminBaseRequest
{
    ...
    {
        return [
            'paypalClientId' => 'required_if:paypalStatus,on',
            'paypalSecret' => 'required_if:paypalStatus,on',
            'apiKey' => 'required_if:stripeStatus,on',
            'apiSecret' => 'required_if:stripeStatus,on',
            'webhookKey' => 'required_if:stripeStatus,on',
            'razorpayKey' => 'required_if:razorpayStatus,on',
            'razorpaySecret' => 'required_if:razorpayStatus,on',
            'razorpayWebhookSecret' => 'required_if:razorpayStatus,on',
            'paypalStatus'=>'',
            'stripeStatus'=>'',
            'razorpayStatus'=>'',
        ];
