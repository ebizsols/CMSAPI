...
use App\Http\Resources\SuperAdmin\FrontSetting\GetAllFeatureImages as GetAllFeatureImagesResource;
use Illuminate\Contracts\Validation\Validator;
use Illuminate\Validation\ValidationException;
use App\Http\Requests\API\SuperAdmin\SuperAdminBaseRequest;

class AllFeatureImagesRequest extends SuperAdminBaseRequest
{
    ...
    {
        return [
            'type'=>'required|exists:features,type'
        ];
    }
    ...
    public function successResponse($data = array(),  $message = '', $code = '')
    {
        ...
        $responseObj = new GetAllFeatureImagesResource($data);
