...
use App\Http\Resources\SuperAdmin\FrontSetting\AddEditFeatureImages as AddEditFeatureImagesResource;
use Illuminate\Contracts\Validation\Validator;
use Illuminate\Validation\ValidationException;
use App\Http\Requests\API\SuperAdmin\SuperAdminBaseRequest;

class AddEditImagesRequest extends SuperAdminBaseRequest
{
    ...
    public function successResponse($data = array(),  $message = '', $code = '')
    {
        ...
        $responseObj = new AddEditFeatureImagesResource($data);
