...
namespace App\Http\Requests\API\SuperAdmin\Invoice;

use App\Helper\ApiResponseHelper;
use App\Http\Resources\SuperAdmin\Invoice\Invoice as InvoiceResource;
...
class ListingRequest extends SuperAdminBaseRequest
{
    ...
    public function successResponse($data = array(),  $message = '', $code = '')
    {
        ...
        $responseObj = new InvoiceResource($data);
