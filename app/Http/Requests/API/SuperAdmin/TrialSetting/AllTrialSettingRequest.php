...
use App\Http\Resources\SuperAdmin\TrialSetting\AllTrialSetting as AllTrialSettingResourece;
use Illuminate\Contracts\Validation\Validator;
use Illuminate\Validation\ValidationException;
use App\Http\Requests\API\SuperAdmin\SuperAdminBaseRequest;

class AllTrialSettingRequest extends SuperAdminBaseRequest
{
...
//           'id' => 'required',
    ...
    public function successResponse($data = array(),  $message = '', $code = '')
    {
        ...
        $responseObj = new AllTrialSettingResourece($data);
