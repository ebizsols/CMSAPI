...
namespace App\Http\Requests\API\SuperAdmin\TrialSetting;

use App\Helper\ApiResponseHelper;
use App\Http\Resources\SuperAdmin\TrialSetting\UpdateTrialSetting as UpdateTrialSettingResourece;
use Illuminate\Contracts\Validation\Validator;
use Illuminate\Validation\ValidationException;
use App\Http\Requests\API\SuperAdmin\SuperAdminBaseRequest;

class UpdateTrialSettingRequest extends SuperAdminBaseRequest
{
    ...
    public function successResponse($data = array(),  $message = '', $code = '')
    {
        ...
        $responseObj = new UpdateTrialSettingResourece($data);
