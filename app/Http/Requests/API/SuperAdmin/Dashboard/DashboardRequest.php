...
namespace App\Http\Requests\API\SuperAdmin\Dashboard;

use App\Helper\ApiResponseHelper;
use App\Http\Resources\SuperAdmin\Dashboard\Dashboard as DashboardResourece;
use Illuminate\Contracts\Validation\Validator;
use Illuminate\Validation\ValidationException;
use App\Http\Requests\API\SuperAdmin\SuperAdminBaseRequest;

class DashboardRequest extends SuperAdminBaseRequest
{
...
//           'id' => 'required',
    ...
    public function successResponse($data = array(),  $message = '', $code = '')
    {
        ...
        $responseObj = new DashboardResourece($data);
