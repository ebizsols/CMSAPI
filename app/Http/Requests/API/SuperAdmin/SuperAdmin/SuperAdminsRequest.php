...
use App\Http\Resources\SuperAdmin\SuperAdmin\SuperAdminCollection;

class SuperAdminsRequest extends SuperAdminBaseRequest
{
    ...
    public function successResponse($data = array(),  $message = '', $code = '')
    {
        ...
        $responseObj = new SuperAdminCollection($data);
