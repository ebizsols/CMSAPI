<?php
namespace App\Http\Requests\API\SuperAdmin\PushNotification;

use App\Helper\ApiResponseHelper;
use App\Http\Resources\SuperAdmin\PushNotification\PushNotificationUpdate as PushNotificationUpdateResource;
use Illuminate\Contracts\Validation\Validator;
use Illuminate\Validation\ValidationException;
use App\Http\Requests\API\SuperAdmin\SuperAdminBaseRequest;

class NotificationRequestUpdate extends SuperAdminBaseRequest
{
    ...
    public function successResponse($data = array(),  $message = '', $code = '')
    {
        ...
        $responseObj = new PushNotificationUpdateResource($data);
